...
var gProjects = [
    ...
    { id: 'book-shop', name: 'Book Shop', title: 'CRUDL Project ', desc: 'This project was a coding challenge to create a book shop with CRUDL', publishedAt: Date.now(), labels: ['HTML', 'CSS', 'JS'] },
    ...
    { id: 'pac', name: 'Sonic Pacman', title: 'Pacman project', desc: 'This project was a good project to learn how to manage file ', publishedAt: Date.now(), labels: ['HTML', 'CSS', 'JS'] },
    ...
    { id: 'ball', name: 'Ball Board', title: 'Collect Dragon Balls', desc: 'This prokect was a good project to practice Matrix and rendering', publishedAt: Date.now(), labels: ['HTML', 'CSS', 'JS'] },
